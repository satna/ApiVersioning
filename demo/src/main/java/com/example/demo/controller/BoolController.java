...
private BookServiceRepo bookServiceRepo;
   public BoolController(BookServiceRepo bookServiceRepo){
    ...
    //query parameter base version
    @GetMapping(value = "/ping",params = "version=1")
    public String ping(){
...
/*       bookList.add(new Book(obj.getBookId(), obj.getTitle(),
    ...
    @GetMapping(value = "/book",params = "version=1")
    ...
    @PutMapping(value = "/{id}",params = "version=1")
    ...
    @DeleteMapping(value = "/{id}", params = "version=1")
    ...
    @DeleteMapping(params = "version=1")
